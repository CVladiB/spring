...
public class LibraryShellController {
    ...
    public String create(String title, String authorSurname, String authorName, String genreNames) {
        List<String> genreNameList = parseServiceImpl.parseLinesToListStrByComma(genreNames);
        BookDTO book;
        return genreNameList.isEmpty() ? bc.WARNING
                : (book = libraryServiceImpl.create(title, authorSurname, authorName, genreNameList)) == null ? bc.WARNING
    ...
    public String createById(String title, Integer authorId, String genreIds) {
        List<Integer> genreIdList = parseServiceImpl.parseLinesToListIntByComma(genreIds);
        BookDTO book;
        return genreIdList.isEmpty() ? bc.WARNING
                : (book = libraryServiceImpl.create(title, authorId, genreIdList)) == null ? bc.WARNING
                : String.format(bc.COMPLETE_CREATE, book.getId());
    }
    ...
    public String update(Integer id, String title, String authorSurname, String authorName, String genreNames) {
        List<String> genreNameList = parseServiceImpl.parseLinesToListStrByComma(genreNames);
        return genreNameList.isEmpty() ? bc.WARNING
                : libraryServiceImpl.update(id, title, authorSurname, authorName, genreNameList) == null ? bc.WARNING
                : bc.COMPLETE_UPDATE;
    }
    ...
    public String updateById(Integer id, String title, Integer authorId, String genreIds) {
        ...
        return genreIdList.isEmpty() ?
                bc.WARNING
                : libraryServiceImpl.update(id, title, authorId, genreIdList) == null ?
                bc.WARNING
                : bc.COMPLETE_UPDATE;
    }
    ...
    public String delete(Integer id) {
        return libraryServiceImpl.delete(id) ? bc.COMPLETE_DELETE : bc.WARNING;
    }
}
